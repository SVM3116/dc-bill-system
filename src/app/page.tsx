...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-slate-50 text-slate-900 antialiased selection:bg-indigo-600 selection:text-white font-sans">
          ...
          <div className="lg:col-span-5 space-y-6 text-left lg:sticky lg:top-24">
            ...
            <div className="space-y-2 pt-4 border-t border-slate-200">
              ...
              <div className="flex flex-wrap gap-1.5">
                ...
                <span className="bg-slate-100 border border-slate-300 px-2.5 py-1 rounded-md text-[9.5px] font-bold text-slate-600">Morarji PU College Hosakote</span>
              </div>
            </div>
      ...
      {/* 7. CENTERED FOOTER */}
      <footer className="border-t border-slate-300 py-8 px-4 md:px-6 bg-white text-center text-xs text-slate-500 shrink-0 mt-auto font-sans">
        <div className="max-w-6xl mx-auto w-full flex flex-col items-center gap-4">
          
          {/* Institutional banner */}
          <p className="text-slate-850 font-black text-sm tracking-tight text-center max-w-xl leading-relaxed">
          ...
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2.5 text-slate-500 font-bold text-[11px]">
            <span className="text-slate-600 font-semibold">Developed by</span>
            <Link href="/developer" className="font-black text-indigo-600 hover:text-indigo-850 transition-colors">
              Manoj Kumar V
            </Link>
            <div className="h-3.5 w-[1px] bg-slate-300" />
            <span className="text-slate-650 font-semibold">Email:</span>
            <a href="mailto:svmmdrpu@gmail.com" className="hover:text-indigo-600 text-slate-700 font-black transition-all">svmmdrpu@gmail.com</a>
            <div className="h-3.5 w-[1px] bg-slate-300" />
            <span className="text-slate-650 font-semibold">Contact:</span>
            <a href="tel:+917975464020" className="hover:text-indigo-600 text-slate-700 font-black transition-all">+91 7975464020</a>
            <div className="h-3.5 w-[1px] bg-slate-300" />
            
            {/* Highly visible, opaque social icon buttons */}
            <div className="flex items-center gap-2">
              <a 
                href="https://github.com/SVM3116" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-1.5 rounded-full text-slate-700 hover:text-indigo-700 hover:bg-slate-200 transition-all border border-slate-300 bg-slate-100 flex items-center justify-center"
                title="GitHub"
              >
              ...
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer" 
                className="p-1.5 rounded-full text-indigo-700 hover:text-indigo-850 hover:bg-indigo-100 transition-all border border-indigo-200 bg-indigo-50 flex items-center justify-center"
                title="LinkedIn"
              >
